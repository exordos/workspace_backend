...
![Sequence diagram](diagrams/get_service.svg)

[The source that you can edit PlantUML](diagrams/get_service.puml)

## Purpose and public contract

Get one available service Workspace.
