...
![Sequence diagram](diagrams/get_files_list.svg)

[The source that you can edit PlantUML](diagrams/get_files_list.puml)

## Purpose and public contract

List the metadata files visible through the public ACL or current membership in the stream.
...
2. Perform indexed checks on ACL/membership.
3. Read visible metadata lines; `project_id` and storage details are hidden.
4. Serial list.
