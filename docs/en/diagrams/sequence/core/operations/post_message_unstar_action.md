...
![Sequence diagram](diagrams/post_message_unstar_action.svg)

The source that you can edit: [`post_message_unstar_action.puml`](diagrams/post_message_unstar_action.puml).

## The operation

**Method and way:** `POST /api/workspace/v1/messenger/messages/{message_uuid}/actions/unstar/invoke`

**Purpose:** Remove global status for the message in the current user's selected.
...
2. Set a unique value USER_MESSAGE_STATE.starred=false.
