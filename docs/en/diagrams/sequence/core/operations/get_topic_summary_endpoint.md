...
![Sequence diagram](diagrams/get_topic_summary_endpoint.svg)

The source that you can edit: [`get_topic_summary_endpoint.puml`](diagrams/get_topic_summary_endpoint.puml).

## The operation

**Method and way:** `GET /api/workspace/v1/messenger/topic_summary_endpoints/{endpoint_uuid}`

**Purpose:** To read one cleaned global endpoint of summaries.

## A public request

Path: `endpoint_uuid = e4ad6d80-6bc7-4a91-864c-8e97319a82bd`; without body.
