...
![Sequence diagram](diagrams/post_stream_unarchive_action.svg)

The source that you can edit: [`post_stream_unarchive_action.puml`](diagrams/post_stream_unarchive_action.puml).

## The operation

**Method and way:** `POST /api/workspace/v1/messenger/streams/{stream_uuid}/actions/unarchive/invoke`

**Purpose:** To establish a canonical meaning `is_archived=false`.
...
2. Set it up STREAM.is_archived=false.
