...
List the cleaned chat catalog of the provider and destination status for the owner.

![Sequence diagram](diagrams/get_external_chats.svg)

[The source that you can edit PlantUML](diagrams/get_external_chats.puml)

## The request

The request parameters are contracted:

- - It 's mandatory . `external_account_uuid`
- `page_limit`
- `page_marker` (UUID The last chat)
...
UUID The UUID fields of the project/stream are indexed external keys, not public URI relationships.
