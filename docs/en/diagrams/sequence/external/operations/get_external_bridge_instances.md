# List of copies of the external bridge
...
List the sanitized identity of the execution time bridges for all providers.

![Sequence diagram](diagrams/get_external_bridge_instances.svg)

[The source that you can edit PlantUML](diagrams/get_external_bridge_instances.puml)

## The request

The request parameters are contracted:

- Documented typed filters/AIP-160 `q`
- `page_limit`
- `page_marker` (UUID The last copy)
