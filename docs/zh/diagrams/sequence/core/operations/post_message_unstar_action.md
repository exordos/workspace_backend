...
![序列图](diagrams/post_message_unstar_action.svg)

可编辑的源: [`post_message_unstar_action.puml`](diagrams/post_message_unstar_action.puml).

## 操作

**方法和方式:** `POST /api/workspace/v1/messenger/messages/{message_uuid}/actions/unstar/invoke`
...
2. 设置一个唯一值 USER_MESSAGE_STATE.starred=false.
