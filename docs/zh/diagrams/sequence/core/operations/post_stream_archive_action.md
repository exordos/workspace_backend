...
![序列图](diagrams/post_stream_archive_action.svg)

可编辑的源: [`post_stream_archive_action.puml`](diagrams/post_stream_archive_action.puml).

## 操作

**方法和方式:** `POST /api/workspace/v1/messenger/streams/{stream_uuid}/actions/archive/invoke`

**目的:** 设置定律的意义 `is_archived=true`.
