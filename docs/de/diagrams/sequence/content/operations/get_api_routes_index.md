...
![Abfolge Diagramm](diagrams/get_api_routes_index.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_api_routes_index.puml)

## Zuordnung und öffentlicher Vertrag

Legen Sie die aktuellen Routen der Sammlungen direkt unter der Wurzel auf Workspace v1.
...
2. Verwenden Sie den registrierten Routenbaum.
