...
![Abfolge Diagramm](diagrams/get_files_list.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_files_list.puml)

## Zuordnung und öffentlicher Vertrag

Liste die Metadaten von Dateien, die über die öffentliche ACL oder die aktuelle Mitgliedschaft im Stream sichtbar sind.
...
2. Führen Sie die Indexprüfungen ACL/Mitgliedschaft durch.
3. Lesen Sie sichtbare Metadatenzeilen; `project_id` und Speicherdetails versteckt.
4. Liste in eine Reihe setzen.
