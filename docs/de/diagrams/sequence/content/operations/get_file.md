...
![Abfolge Diagramm](diagrams/get_file.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_file.puml)

## Zuordnung und öffentlicher Vertrag

Erhalten Sie einen sichtbaren Metadaten-Eintrag der Datei.
...
1. Authentifizieren.
2. Metadaten nach UUID.
3. Überprüfen Sie die öffentliche ACL oder aktuelle indexierte Bindung des Stroms.
4. Die gesäuberte Metadatenzeile zurückgeben.
