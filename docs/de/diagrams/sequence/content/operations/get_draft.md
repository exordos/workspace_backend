...
![Abfolge Diagramm](diagrams/get_draft.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_draft.puml)

## Zuordnung und öffentlicher Vertrag

Erhalten Sie einen Entwurf des Eigentümers und eine strenge ETag seine Revision.
...
Antwortüberschrift: `ETag: "1"` (aktuelle strenge Revision)).
