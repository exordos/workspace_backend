...
Liste der externen Konten des aktuellen Benutzers, die für das Gebiet global sind IAM.

![Folgebild](diagrams/get_external_accounts.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_external_accounts.puml)
...
- `status`
- `page_limit`
- `page_marker` (UUID Letzter Eintrag)
