# Das Exemplar der Außenbrücke erhalten
...
Einen gesundheitspflegten Bildschirm von Identität, Fähigkeiten, Gesundheit und dem Zertifikat der Brücke zurückgeben..

![Folgebild](diagrams/get_external_bridge_instance.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_external_bridge_instance.puml)
