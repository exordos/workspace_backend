...
Zurück eine gesundheitsgerechte Operation in der Eigentümerregion, einschließlich einer begrenzten Geschichte von Versuchen und Abgleich.

![Folgebild](diagrams/get_external_operation.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_external_operation.puml)
