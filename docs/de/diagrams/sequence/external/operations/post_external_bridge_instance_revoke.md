# Abruf eines Exemplars der Außenbrücke

[← Hauptindex der Dokumentation](../../../../index.md) ·
[Index der Abfolge-Diagramme](../../README.md) ·
[Abschnitt Außenintegration/runtime](../README.md)

`POST /api/workspace/v1/messenger/external_bridge_instances/{instance_uuid}/actions/revoke/invoke`

Aktive Zertifikatgeneration nicht rückgängig machen.

![Folgebild](diagrams/post_external_bridge_instance_revoke.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/post_external_bridge_instance_revoke.puml)
...
| --- | --- |
| `403` | `workspace.external_bridge_instance.revoke` ist nicht zugelassen oder die Ressource befindet sich außerhalb des autorisierten Bereichs. |
...
2. Sperren Sie die Bridge-Instanz; Verwenden Sie den `revoke`-Zustandsschritt und die Revisions-/Generierungsregel; Schreiben Sie einen unveränderlichen Domain-Outbox-Eintrag; Verwalten Sie die Transaktion.
