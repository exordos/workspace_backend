# Liste der externen Operationen
...
Liste der mit dem Provider verbundenen Betriebs- und Betriebssicherheiten des Eigentümers.

![Folgebild](diagrams/get_external_operations.svg)

[Ausgangsgestalt , die bearbeitet werden kann PlantUML](diagrams/get_external_operations.puml)

## Anfrage

Abfrage-Parametervertrag:

- - Ohne Anspruch `external_account_uuid`
- - Ohne Anspruch `status`
- `page_limit`
- `page_marker` (UUID Die letzte Operation)
