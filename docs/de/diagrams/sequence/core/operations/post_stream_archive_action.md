...
![Abfolge Diagramm](diagrams/post_stream_archive_action.svg)

Ausgangsgestalt , die bearbeitet werden kann: [`post_stream_archive_action.puml`](diagrams/post_stream_archive_action.puml).

## Die Operation

**Methode und Weg:** `POST /api/workspace/v1/messenger/streams/{stream_uuid}/actions/archive/invoke`

**Zweck:** Kanonische Bedeutung festlegen `is_archived=true`.
...
2. Setzen STREAM.is_archived=true.
