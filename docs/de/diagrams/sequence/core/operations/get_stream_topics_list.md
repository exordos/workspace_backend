...
![Abfolge Diagramm](diagrams/get_stream_topics_list.svg)

Ausgangsgestalt , die bearbeitet werden kann: [`get_stream_topics_list.puml`](diagrams/get_stream_topics_list.puml).

## Die Operation

**Methode und Weg:** `GET /api/workspace/v1/messenger/stream_topics/`

**Zweck:** Erhalten Sie eine Liste der für den Benutzer sichtbaren Themenzeilen.
...
1. Scan einzigartige ZeilenUSER_TOPIC_BINDINGDie Kanonischen werden hinzugefügt .TOPIC, STREAMUnd das letzte .MESSAGE. Die Zähler sind bereit für die Bindung; Aggregation während der Anfrage wird nicht ausgeführt.
