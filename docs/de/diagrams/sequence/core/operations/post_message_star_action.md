...
![Abfolge Diagramm](diagrams/post_message_star_action.svg)

Ausgangsgestalt , die bearbeitet werden kann: [`post_message_star_action.puml`](diagrams/post_message_star_action.puml).

## Die Operation

**Methode und Weg:** `POST /api/workspace/v1/messenger/messages/{message_uuid}/actions/star/invoke`

**Zweck:** Den globalen Status in der gewählten des aktuellen Benutzers für die Nachricht festlegen.
...
2. Einzigartiger Wert festlegen USER_MESSAGE_STATE.starred=true.
