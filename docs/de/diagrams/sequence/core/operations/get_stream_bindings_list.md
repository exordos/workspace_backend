...
![Abfolge Diagramm](diagrams/get_stream_bindings_list.svg)

Ausgangsgestalt , die bearbeitet werden kann: [`get_stream_bindings_list.puml`](diagrams/get_stream_bindings_list.puml).

## Die Operation

**Methode und Weg:** `GET /api/workspace/v1/messenger/stream_bindings/`

**Zweck:** Erhalten Sie eine Liste der sichtbaren Bindungen des Flusses.
...
1. Scannen Sie die indizierten Zeilen USER_STREAM_BINDING im Beobachter- und Projektbereich; nur aktuelle Bindungsfelder ohne aggregierendes Scannen serienmäßig.
