...
| `description` | Строка, максимум 10000 | Нет | Нет | Описание потока; по умолчанию пустая строка. |
| `project_id` | UUID | Нет | Да, я знаю. | IAM объем проекта. |
...
| `description` | Строка, максимум 10000 | Нет | Нет | Описание файла; по умолчанию пустая строка. |
...
| `description` | Строка, максимум 10000 | Описание службы; по умолчанию пустая строка. |
