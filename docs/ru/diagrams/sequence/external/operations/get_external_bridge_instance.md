# Получение экземпляра внешнего моста
...
Вернуть один санитизированный снимок идентичности, возможностей, здоровья и сертификата моста.

![Диаграмма последовательностей](diagrams/get_external_bridge_instance.svg)

[Редактируемый исходник PlantUML](diagrams/get_external_bridge_instance.puml)
