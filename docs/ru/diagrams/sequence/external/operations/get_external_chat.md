...
Вернуть один санитизированный снимок чата в области владельца.

![Диаграмма последовательностей](diagrams/get_external_chat.svg)

[Редактируемый исходник PlantUML](diagrams/get_external_chat.puml)
