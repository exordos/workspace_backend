# Возобновление политики внешнего провайдера
...
Возобновить вид провайдера во всём realm после проверки политики.

![Диаграмма последовательностей](diagrams/post_external_provider_policy_resume.svg)

[Редактируемый исходник PlantUML](diagrams/post_external_provider_policy_resume.puml)
...
| --- | --- |
| `403` | Отсутствует разрешение `workspace.external_provider_policy.resume` или ресурс находится вне авторизованной области. |
...
2. Заблокировать политику; установить `emergency_suspended=false`; увеличить ревизию; атомарно добавить желаемое состояние и неизменяемый outbox.
