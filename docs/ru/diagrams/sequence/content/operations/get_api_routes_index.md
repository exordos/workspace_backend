...
![Диаграмма последовательности](diagrams/get_api_routes_index.svg)

[Редактируемый исходник PlantUML](diagrams/get_api_routes_index.puml)

## Назначение и публичный контракт

Перечислить текущие имена маршрутов коллекций непосредственно под корнем Workspace v1.
...
2. Проверить в памяти зарегистрированное дерево маршрутов.
