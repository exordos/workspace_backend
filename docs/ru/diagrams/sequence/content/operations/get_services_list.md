...
![Диаграмма последовательности](diagrams/get_services_list.svg)

[Редактируемый исходник PlantUML](diagrams/get_services_list.puml)

## Назначение и публичный контракт

Перечислить доступные сервисы Workspace.
