...
![Диаграмма последовательности](diagrams/get_files_list.svg)

[Редактируемый исходник PlantUML](diagrams/get_files_list.puml)

## Назначение и публичный контракт

Перечислить метаданные файлов, видимых через публичный ACL или текущее членство в потоке.
...
2. Выполнить индексированные проверки ACL/членства.
3. Прочитать видимые строки метаданных; `project_id` и детали хранилища скрыты.
4. Сериализовать список.
