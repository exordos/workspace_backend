...
![Диаграмма последовательности](diagrams/get_draft.svg)

[Редактируемый исходник PlantUML](diagrams/get_draft.puml)

## Назначение и публичный контракт

Получить один черновик владельца и строгий ETag его ревизии.
...
Заголовок ответа: `ETag: "1"` (текущая строгая ревизия).
