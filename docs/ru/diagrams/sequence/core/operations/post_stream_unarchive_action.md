...
![Диаграмма последовательности](diagrams/post_stream_unarchive_action.svg)

Редактируемый исходник: [`post_stream_unarchive_action.puml`](diagrams/post_stream_unarchive_action.puml).

## Операция

**Метод и путь:** `POST /api/workspace/v1/messenger/streams/{stream_uuid}/actions/unarchive/invoke`

**Назначение:** Установить каноническое значение `is_archived=false`.
...
2. Установить STREAM.is_archived=false.
