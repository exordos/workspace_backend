...
![Диаграмма последовательности](diagrams/post_message_star_action.svg)

Редактируемый исходник: [`post_message_star_action.puml`](diagrams/post_message_star_action.puml).

## Операция

**Метод и путь:** `POST /api/workspace/v1/messenger/messages/{message_uuid}/actions/star/invoke`

**Назначение:** Установить глобальное для сообщения состояние «в избранном» текущего пользователя.
...
2. Установить уникальное значение USER_MESSAGE_STATE.starred=true.
