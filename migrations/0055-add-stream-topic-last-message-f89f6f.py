...
class MigrationStep(migrations.AbstractMigrationStep):
    ...
    def __init__(self):
        self._depends = ["0054-add-stream-topic-colors-4ee519.py"]

    @property
    def migration_id(self):
        return "f89f6f19-3e05-4eae-b96e-26af138e735f"
    ...
    def upgrade(self, session):
        expressions = [
            ...
            CREATE INDEX IF NOT EXISTS
                "m_workspace_messages_stream_last_message_idx"
            ...
            """
            CREATE INDEX IF NOT EXISTS
                "m_workspace_messages_topic_last_message_idx"
                ON "m_workspace_messages" (
                    "project_id",
                    "topic_uuid",
                    "created_at" DESC,
    ...
    def downgrade(self, session):
        expressions = [
            ...
            PREVIOUS_USER_STREAMS_VIEW_SQL,
            """
            DROP INDEX IF EXISTS "m_workspace_messages_topic_last_message_idx";
            """,
            """
            DROP INDEX IF EXISTS "m_workspace_messages_stream_last_message_idx";
            """,
        ]
