...
def _lease_fence(capability_name: str, minimum_revision: int) -> str:
    return f"""
...
class MigrationStep(migrations.AbstractMigrationStep):
    ...
    def migration_id(self):
        return "523aa199-3aad-4678-b915-5b5439bb9f85"
    ...
    def upgrade(self, session):
        session.execute(
            _lease_fence("messenger.message.read.paging", 1),
        )

    def downgrade(self, session):
        session.execute(
            _lease_fence("messenger.message.read", 2),
        )
